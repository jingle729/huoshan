...
public class RequestLicenseTask extends AsyncTask<String, Void, Boolean> {
    ...
    private ILicenseViewCallback mCallback;
    ...
    protected Boolean doInBackground(String... strings) {
        ...
        try {
            ...
            licenseHelper.getLicensePath(EffectsSDKLicenseInterface.LICENSE_FUNCTION_NAME.EFFECT);
            ...
            if (isEditingMode || savedVersionCode < currentVersionCode || overSeasChanged) {
                ...
                licenseHelper.updateLicensePath();
            }
