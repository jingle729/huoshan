...
public class StickerViewHolder extends RecyclerView.ViewHolder{
    ...
    private int drawableSelected = com.effectsar.labcv.common.R.drawable.bg_item_focused;
    private int drawableUnselected = com.effectsar.labcv.common.R.drawable.bg_item_unselect_selector;
    ...
    public StickerViewHolder(@NonNull View itemView) {
        ...
        colorOn = ActivityCompat.getColor(itemView.getContext(), com.effectsar.labcv.common.R.color.colorWhite);
        colorOff = ActivityCompat.getColor(itemView.getContext(), com.effectsar.labcv.common.R.color.colorGrey);
    }
