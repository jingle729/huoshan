            ...
            if (item.hasChildren()) {
                ...
                if ( localParamList!=null && localParamList.size() > 0) {
                    ...
                    for (int i = 0; i < localParamList.size(); i++) {
                        for (int y = 0; y < item.getAvailableItem().getNode().getKeyArray().length; y++) {
                            if (item.getAvailableItem().getNode().getKeyArray()[y].equals(localParamList.get(i).key)) {
                                item.getAvailableItem().getIntensityArray()[y] = localParamList.get(i).intensity;
                            }
                        }
                }
