...
import com.effectsar.labcv.effect.adapter.EffectSelectRVAdapter;
...
//    private EffectRVAdapter mAdapter;
    ...
    public TryOnFragment setTryOnCallBack(ITryOnCallBack mCallback) {
    ...
    public TryOnFragment setData(EffectButtonItem item) {
        mItemGroup = item;
    ...
    public TryOnFragment usePoint(boolean usePoint) {
        mUsePoint = usePoint;
        return this;
    }
     ...
     * @return
     */
    public TryOnFragment setSelectNodes(Set<EffectButtonItem> selectNode) {
