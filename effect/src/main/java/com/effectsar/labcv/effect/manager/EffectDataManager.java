...
public class EffectDataManager {
    ...
    //   {zh} 新引擎滤镜 {en} Amazing Filter
    public static final int TYPE_FILTER_AMG             = 42 << OFFSET;
...
//     {zh} 美白     {en} whitening
    ...
    public static final int TYPE_BEAUTY_FACE_WHITEN_HONGRUN            = TYPE_BEAUTY_FACE_WHITEN + (14 << SUB_OFFSET);
    public static final int TYPE_BEAUTY_FACE_WHITEN_XIAOMAI             = TYPE_BEAUTY_FACE_WHITEN + (15 << SUB_OFFSET);
    public static final int TYPE_BEAUTY_FACE_WHITEN_MEIHEI              = TYPE_BEAUTY_FACE_WHITEN + (16 << SUB_OFFSET);
    ...
    public static final int TYPE_BEAUTY_RESHAPE_FACE_SHORT      = TYPE_BEAUTY_RESHAPE + (14 << SUB_OFFSET);// {zh} 小脸 {en} Little face
    ...
    public static final int TYPE_BEAUTY_BODY_ALL = TYPE_BEAUTY_BODY + (10 << SUB_OFFSET);
    ...
    //    {zh} 新引擎滤镜        {en} Amazing Filter
    public static final int  TYPE_FILTER_AMG_PORTRAIT       = TYPE_FILTER_AMG  + (1 << SUB_OFFSET); //   {zh} 人像  {en} portrait
    public static final int  TYPE_FILTER_AMG_CUISINE        = TYPE_FILTER_AMG  + (2 << SUB_OFFSET); //   {zh} 美食  {en} cuisine
    public static final int  TYPE_FILTER_AMG_LANDSCAPE      = TYPE_FILTER_AMG  + (3 << SUB_OFFSET); //   {zh} 风景  {en} landscape
    public static final int  TYPE_FILTER_AMG_VINTAGE        = TYPE_FILTER_AMG  + (4 << SUB_OFFSET); //   {zh} 复古  {en} vintage
    public static final int  TYPE_FILTER_AMG_STYLIZATION    = TYPE_FILTER_AMG  + (5 << SUB_OFFSET); //   {zh} 风格化  {en} stylization
    ...
    static String NODE_RESHAPE_V8 = "reshape_v8";
    static String NODE_RESHAPE_FOREHEAD = "reshape_forehead";
...
//        return new String[][] {nodes, tags};
    ...
    public synchronized Set<EffectButtonItem> getDefaultItems() {
...
//                        item.setSelectedRelation(true);
    ...
    public  Set<EffectButtonItem> getLocalStoredItems(int status) {
        ...
        EffectButtonItem amgFilter = getItem(TYPE_FILTER_AMG);
        for (EffectButtonItem item : amgFilter.getChildren()) {
            if (item.hasChildren()){
                for (EffectButtonItem child: item.getChildren()){
                    if (
                            child.getNode() != null
    ...
    static {
        ...
        //   {zh} 美颜       {en} Beauty  
        // beauty face
        Object put = standardMap.put(TYPE_BEAUTY_FACE_SMOOTH, 0.5F);
        standardMap.put(TYPE_BEAUTY_FACE_WHITEN_DEFAULT, new float[] {0.4F,0.5F} );
        standardMap.put(TYPE_BEAUTY_FACE_WHITEN_LENGBAI, new float[] {0.4F,0.5F} );
        standardMap.put(TYPE_BEAUTY_FACE_WHITEN_FENBAI, new float[] {0.4F,0.5F} );
        standardMap.put(TYPE_BEAUTY_FACE_WHITEN_MEIHEI, new float[] {0.4F,0.5F} );
        standardMap.put(TYPE_BEAUTY_FACE_WHITEN_XIAOMAI, new float[] {0.4F,0.5F} );
        standardMap.put(TYPE_BEAUTY_FACE_SHARPEN, 0.0F);
        standardMap.put(TYPE_BEAUTY_FACE_CLARITY, 0.4F);
        //   {zh} 美型       {en} Beauty  
        // beaury reshape
        //  {zh} 面部  {en} Facial
        standardMap.put(TYPE_BEAUTY_RESHAPE_FACE_OVERALL1, 0.35F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_FACE_OVERALL2, 0.35F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_FACE_OVERALL3, 0.35F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_FACE_OVERALL4, 0.35F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_CHEEK, 0.6F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_FOREHEAD, 0.70F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_SMILE_FOLDS, 0.8F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_FACE_CUT, 0.5F);
        standardMap.put(TYPE_BEAUTY_BODY_SHRINK_HEAD, 0.35F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_JAW,0.55F);

        //  {zh} 眼睛  {en} Eyes
        standardMap.put(TYPE_BEAUTY_RESHAPE_EYE_SIZE, 0.65F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_BRIGHTEN_EYE, 0.4F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_REMOVE_POUCH, 0.8F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_EYE_LOWER_EYELID, 0.6F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_EYE_PUPIL, 0.55F);


        //  {zh} 鼻子  {en} Nose
        standardMap.put(TYPE_BEAUTY_RESHAPE_NOSE_SIZE, 0.65F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_NOSE_MOVE, 0.6F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_NOSE_SWING, 0.6F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_NOSE_BRIDGE, 0.6F);
        ...
        standardMap.put(TYPE_BEAUTY_RESHAPE_MOUTH_MOVE, 0.6F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_WHITEN_TEETH, 0.3F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_MOUTH_WIDTH, 0.45F);
        standardMap.put(TYPE_BEAUTY_RESHAPE_MOUTH_SMILE, 0.05F);
        ...
        standardMap.put(TYPE_MAKEUP_FACIAL, 0.4F);
        standardMap.put(TYPE_MAKEUP_EYEBROW, new float[] {0.3F,0F,0F,0F});
        standardMap.put(TYPE_MAKEUP_EYESHADOW, 0.2F);
        ...
        standardMap.put(TYPE_STYLE_MAKEUP_2D, new float[] {0.4f, 0.6f});
        standardMap.put(TYPE_STYLE_MAKEUP_3D, new float[] {0.4f, 0.6f});

        //   {zh} 滤镜       {en} Filter  
        // filter
        standardMap.put(TYPE_FILTER, 0.8F);
        standardMap.put(TYPE_FILTER_AMG, 0.8F);
...
//        standardMap.put(TYPE_PALETTE_VIGNETTING     , 0.0F);
        ...
        //   {zh} 美颜       {en} Beauty  
        // beauty face
        liteMap.put(TYPE_BEAUTY_FACE_SMOOTH, 0.6F);
        liteMap.put(TYPE_BEAUTY_FACE_WHITEN_DEFAULT, 0.3F);
        liteMap.put(TYPE_BEAUTY_FACE_WHITEN_LENGBAI, 0.3F);
        liteMap.put(TYPE_BEAUTY_FACE_WHITEN_FENBAI, 0.3F);
        liteMap.put(TYPE_BEAUTY_FACE_WHITEN_HONGRUN, 0.3F);
        liteMap.put(TYPE_BEAUTY_FACE_SHARPEN, 0.0F);
        liteMap.put(TYPE_BEAUTY_FACE_CLARITY, 0.4F);

        //   {zh} 美型       {en} Beauty  
        // beauty reshape
        liteMap.put(TYPE_BEAUTY_RESHAPE_FACE_OVERALL1, 0.30F);
        liteMap.put(TYPE_BEAUTY_RESHAPE_FACE_OVERALL2, 0.30F);
        liteMap.put(TYPE_BEAUTY_RESHAPE_FACE_OVERALL3, 0.30F);
        liteMap.put(TYPE_BEAUTY_RESHAPE_FACE_OVERALL4, 0.30F);
        ...
        //  {zh} 眼睛  {en} Eyes
        liteMap.put(TYPE_BEAUTY_RESHAPE_EYE_SIZE, 0.3F);
        ...
        liteMap.put(TYPE_STYLE_MAKEUP_2D, new float[] {0.4f, 0.6f});
        liteMap.put(TYPE_STYLE_MAKEUP_3D, new float[] {0.4f, 0.6f});

        //   {zh} 滤镜       {en} Filter  
        // filter
        liteMap.put(TYPE_FILTER, 0.8F);
        liteMap.put(TYPE_FILTER_AMG, 0.8F);
   ...
   private static HashMap<Integer, ArrayList<ColorItem>> colorForChooseMap = new HashMap<>();
    ...
    static {
        ...
        DefaultLiteEffects.add(TYPE_BEAUTY_FACE_CLARITY);
        DefaultLiteEffects.add(TYPE_BEAUTY_RESHAPE_SMILE_FOLDS);
        DefaultLiteEffects.add(TYPE_BEAUTY_RESHAPE_FACE_OVERALL4);
        DefaultLiteEffects.add(TYPE_BEAUTY_RESHAPE_REMOVE_POUCH);
        DefaultLiteEffects.add(TYPE_BEAUTY_RESHAPE_EYE_SIZE);
        DefaultLiteEffects.add(TYPE_BEAUTY_RESHAPE_NOSE_SIZE);
        DefaultLiteEffects.add(TYPE_BEAUTY_RESHAPE_MOUTH_SMILE);
    ...
    static {
        ...
        DefaultStandardEffects.add(TYPE_BEAUTY_FACE_CLARITY);
        DefaultStandardEffects.add(TYPE_BEAUTY_RESHAPE_FACE_OVERALL4);
        DefaultStandardEffects.add(TYPE_BEAUTY_RESHAPE_EYE_SIZE);
        DefaultStandardEffects.add(TYPE_BEAUTY_BODY_SHRINK_HEAD);
        DefaultStandardEffects.add(TYPE_BEAUTY_RESHAPE_CHEEK);
        DefaultStandardEffects.add(TYPE_BEAUTY_RESHAPE_JAW);
        DefaultStandardEffects.add(TYPE_BEAUTY_RESHAPE_SMILE_FOLDS);
        DefaultStandardEffects.add(TYPE_BEAUTY_RESHAPE_EYE_LOWER_EYELID);
        DefaultStandardEffects.add(TYPE_BEAUTY_RESHAPE_EYE_PUPIL);
        DefaultStandardEffects.add(TYPE_BEAUTY_RESHAPE_REMOVE_POUCH);
        DefaultStandardEffects.add(TYPE_BEAUTY_RESHAPE_NOSE_SIZE);
        DefaultStandardEffects.add(TYPE_BEAUTY_RESHAPE_NOSE_SWING);
        DefaultStandardEffects.add(TYPE_BEAUTY_RESHAPE_NOSE_BRIDGE);
        DefaultStandardEffects.add(TYPE_BEAUTY_RESHAPE_MOUTH_WIDTH);
        DefaultStandardEffects.add(TYPE_BEAUTY_RESHAPE_MOUTH_MOVE);
        DefaultStandardEffects.add(TYPE_BEAUTY_RESHAPE_MOUTH_SMILE);

    }

    private static Map<String, Integer> TextDictionary = new HashMap<>();
    static {
...
//                break;
            ...
            case TYPE_BEAUTY_SUIT:
                item = getSuitItems();
                break;
            case TYPE_FILTER_AMG:
                item = getAmgFilterItems();
                break;
        }
        if (item != null) {
    ...
    private  EffectButtonItem getBeautyFaceItemsLite() {
        ...
        ArrayList<EffectButtonItem> items = new ArrayList<>();
            ...
            items.add(new EffectButtonItem(TYPE_BEAUTY_FACE_SMOOTH, R.drawable.ic_beauty_smooth, R.string.beauty_face_smooth, new ComposerNode("beauty_Android_lite", "smooth", getDefaultIntensity(TYPE_BEAUTY_FACE_SMOOTH, mEffectType)[0])));
            if (hasWhiten()){
            ...
            items.add(new EffectButtonItem(TYPE_BEAUTY_FACE_SHARPEN, R.drawable.ic_beauty_sharpen, R.string.beauty_face_sharpen, new ComposerNode("sharpen_Android_lite", "sharp", getDefaultIntensity(TYPE_BEAUTY_FACE_SHARPEN, mEffectType)[0])));
            items.add(new EffectButtonItem(TYPE_BEAUTY_FACE_CLARITY, R.drawable.ic_beauty_clarity, R.string.beauty_face_clarity, new ComposerNode("whiten_clear_Android_lite", "clear", getDefaultIntensity(TYPE_BEAUTY_FACE_CLARITY, mEffectType)[0])));
...
//            items.add(new EffectButtonItem(TYPE_BEAUTY_FACE_WHITEN_DEFAULT, R.drawable.ic_beauty_whiten, R.string.beauty_face_whiten, new ComposerNode(beautyNode, "whiten", getDefaultIntensity(TYPE_BEAUTY_FACE_WHITEN_DEFAULT, mEffectType)[0])));
    ...
    public EffectButtonItem getSuitItems(){
        EffectButtonItem suitItems = new EffectButtonItem(TYPE_BEAUTY_SUIT,
                new EffectButtonItem[]{
                        ...
                        getSuitDefautItem(),
                        new EffectButtonItem(TYPE_BEAUTY_SUIT_FACE_JUVENILE, R.drawable.ic_beauty_suit_juvenile, R.string.beauty_suit_face_juvenile, new ComposerNode("")),
                        new EffectButtonItem(TYPE_BEAUTY_SUIT_FACE_ROUND, R.drawable.ic_beauty_suit_round, R.string.beauty_suit_face_round, new ComposerNode("")),
                        new EffectButtonItem(TYPE_BEAUTY_SUIT_FACE_LONG, R.drawable.ic_beauty_suit_long, R.string.beauty_suit_face_long, new ComposerNode("")),
                        new EffectButtonItem(TYPE_BEAUTY_SUIT_FACE_SQUARE, R.drawable.ic_beauty_suit_square, R.string.beauty_suit_face_square, new ComposerNode("")),
                },
                false
        );
    ...
    public HashMap<EffectButtonItem, Float> getSuitItemsAndDefaultValue(int type){
        ...
        switch (type) {
            case TYPE_BEAUTY_SUIT_FACE_DEFAUT: {
                ...
                map.put(mEffectFaceItems.get(TYPE_BEAUTY_FACE_SMOOTH), 0.60f);
                if (hasWhiten()){
                    // {zh} 美白 {en} Whitening
                    map.put(mEffectFaceItems.get(TYPE_BEAUTY_FACE_WHITEN_DEFAULT), 0.3f);
                }
                // {zh} 锐化 {en} Sharpen
                map.put(mEffectFaceItems.get(TYPE_BEAUTY_FACE_CLARITY), 0.4f);
                // {zh} 瘦脸 {en} Thin face
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_SMILE_FOLDS), 0.35f);

                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_REMOVE_POUCH), 0.5f);

                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_FACE_OVERALL4), 0.3f);

                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_NOSE_SIZE), 0.65f);

                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_MOUTH_SMILE), 0.2f);
                // {zh} 大眼 {en} Big eyes
            ...
            case TYPE_BEAUTY_SUIT_FACE_JUVENILE: {
                // {zh} 磨皮 {en} Dermabrasion
                map.put(mEffectFaceItems.get(TYPE_BEAUTY_FACE_SMOOTH), 0.6f);
                ...
                map.put(mEffectFaceItems.get(TYPE_BEAUTY_FACE_CLARITY), 0.4f);
                // {zh} 瘦脸 {en} Thin face
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_FACE_OVERALL4), 0.2f);
                // {zh} 小脸 {en} Little face
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_FACE_SMALL), 0.3f);
                // {zh} 小头 {en} Small head
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_BODY_SHRINK_HEAD), 0.2f);
                // {zh} 颧骨 {en} Zygomatic
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_CHEEK), 0.5f);
                // {zh} 下巴长短 {en} Chin length
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_CHIN), 0.25f);
                // {zh} 发际线 {en} Hairline
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_FOREHEAD), 0.9f);
                ...
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_REMOVE_POUCH), 0.5f);
                // {zh} 鼻翼 {en} Nose wing
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_NOSE_SIZE), 0.8f);
                // {zh} 鼻子提升 {en} Nose move
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_NOSE_MOVE), 0.25f);
                // {zh} 嘴巴位置 {en} Mouth position
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_MOUTH_MOVE), 0.9f);
                // {zh} 微笑唇 {en} Mouth smile
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_MOUTH_SMILE), 0.2f);
            ...
            case TYPE_BEAUTY_SUIT_FACE_ROUND: {
                ...
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_FACE_OVERALL4), 0.2f);
                // {zh} 小脸 {en} Little face
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_FACE_SMALL), 0.2f);
                // {zh} 窄脸 {en} Cut face
                ...
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_REMOVE_POUCH), 0.5f);
                // {zh} 鼻翼 {en} Nose wing
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_NOSE_SIZE), 0.7f);
                // {zh} 微笑唇 {en} Mouth smile
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_MOUTH_SMILE), 0.2f);
                break;
            }
            case TYPE_BEAUTY_SUIT_FACE_SQUARE:{
                ...
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_CHEEK), 0.5f);
                // {zh} 下颌 {en} Jaw
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_JAW), 0.6f);
                // {zh} 法令纹 {en} Nasolabial folds
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_SMILE_FOLDS), 0.35f);
                // {zh} 眼睛大小 {en} Eye size
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_EYE_SIZE), 0.3f);
            ...
            case TYPE_BEAUTY_SUIT_FACE_LONG:{
                ...
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_CHEEK), 0.5f);
                // {zh} 下巴长短 {en} Jaw
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_CHIN), 0.2f);
                // {zh} 法令纹 {en} Nasolabial folds
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_SMILE_FOLDS), 0.35f);
                // {zh} 眼睛大小 {en} Eye size
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_EYE_SIZE), 0.3f);
                ...
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_NOSE_SIZE), 0.7f);
                // {zh} 鼻子提升 {en} Nose move
                map.put(mEffectReshapeItems.get(TYPE_BEAUTY_RESHAPE_NOSE_MOVE), 0.1f);
                // {zh} 嘴巴位置 {en} Mouth position
    ...
    private EffectButtonItem getBeautyReshapeItemsLite(){
        ...
        String reshapeV8Path = "reshape_v8_lite";
...
//                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_OVERALL, R.drawable.ic_beauty_cheek_reshape, R.string.beauty_reshape_face_overall, new ComposerNode(NODE_RESHAPE_LITE, "Internal_Deform_Overall", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_OVERALL,mEffectType)[0])),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_SMALL, R.drawable.ic_beauty_reshape_face_small, R.string.beauty_reshape_face_small, new ComposerNode(reshapeV8Path, "Internal_Deform_Face", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_SMALL,mEffectType)[0])),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_CUT, R.drawable.ic_beauty_reshape_face_cut, R.string.beauty_reshape_face_cut, new ComposerNode(reshapeV8Path, "Internal_Deform_CutFace", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_CUT,mEffectType)[0])),
                new EffectButtonItem(TYPE_BEAUTY_BODY_SHRINK_HEAD, R.drawable.ic_beauty_body_shrink_head, R.string.beauty_body_shrink_head, new ComposerNode(reshapeV8Path, "BEF_BEAUTY_BODY_SHRINK_HEAD",getDefaultIntensity(TYPE_BEAUTY_BODY_SHRINK_HEAD,null)[0])),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_CHEEK, R.drawable.ic_beauty_reshape_cheek, R.string.beauty_reshape_face_cheek, new ComposerNode(reshapeV8Path, "Internal_Deform_Zoom_Cheekbone",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_CHEEK,mEffectType)[0])),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_JAW, R.drawable.ic_beauty_reshape_jaw, R.string.beauty_reshape_face_jaw, new ComposerNode(reshapeV8Path, "Internal_Deform_Zoom_Jawbone",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_JAW,mEffectType)[0])),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_CHIN, R.drawable.ic_beauty_reshape_chin, R.string.beauty_reshape_face_chin, new ComposerNode(reshapeV8Path, "Internal_Deform_Chin",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_CHIN,mEffectType,true)[0]),true),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FOREHEAD, R.drawable.ic_beauty_reshape_forehead, R.string.beauty_reshape_forehead, new ComposerNode(reshapeV8Path, "Internal_Deform_Forehead",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FOREHEAD,mEffectType,true)[0]),true),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_SMILE_FOLDS, R.drawable.ic_beauty_reshape_smile_folds, R.string.beauty_face_smile_folds, new ComposerNode("beauty_Android_lite", "BEF_BEAUTY_SMILES_FOLDS",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_SMILE_FOLDS,mEffectType)[0]))
        ...
        eye_items.add(new EffectButtonItem(TYPE_BEAUTY_RESHAPE_EYE_SIZE, R.drawable.ic_reshape_eye_size, R.string.beauty_reshape_eye_size, new ComposerNode(reshapeV8Path, "Internal_Deform_Eye", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_EYE_SIZE,mEffectType)[0])));
        eye_items.add(new EffectButtonItem(TYPE_BEAUTY_RESHAPE_EYE_MOVE, R.drawable.ic_reshape_eye_move, R.string.beauty_reshape_eye_move, new ComposerNode(reshapeV8Path, "Internal_Deform_Eye_Move",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_EYE_MOVE,mEffectType)[0])));
        eye_items.add(new EffectButtonItem(TYPE_BEAUTY_RESHAPE_EYE_SPACING, R.drawable.ic_reshape_eye_spacing, R.string.beauty_reshape_eye_spacing, new ComposerNode(reshapeV8Path, "Internal_Eye_Spacing",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_EYE_SPACING,mEffectType)[0])));
        eye_items.add(new EffectButtonItem(TYPE_BEAUTY_RESHAPE_EYE_ROTATE, R.drawable.ic_reshape_eye_rotate, R.string.beauty_reshape_eye_rotate, new ComposerNode(reshapeV8Path, "Internal_Deform_RotateEye",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_EYE_ROTATE,mEffectType)[0])));
        eye_items.add(new EffectButtonItem(TYPE_BEAUTY_RESHAPE_BRIGHTEN_EYE, R.drawable.ic_reshape_eye_brighten, R.string.beauty_face_brighten_eye,new ComposerNode("beauty_Android_lite", "BEF_BEAUTY_BRIGHTEN_EYE",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_BRIGHTEN_EYE,mEffectType)[0])));
        eye_items.add(new EffectButtonItem(TYPE_BEAUTY_RESHAPE_REMOVE_POUCH, R.drawable.ic_reshape_eye_remove_pouch, R.string.beauty_face_remove_pouch, new ComposerNode("beauty_Android_lite", "BEF_BEAUTY_REMOVE_POUCH",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_REMOVE_POUCH,mEffectType)[0])));
        ...
        EffectButtonItem noseGroup = new EffectButtonItem(TYPE_BEAUTY_RESHAPE_NOSE,R.drawable.icon_nose,R.string.beauty_reshape_nose_group, new EffectButtonItem[]{
                new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border, R.string.close),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_NOSE_SIZE, R.drawable.ic_reshape_nose_size, R.string.beauty_reshape_nose_deform,new ComposerNode(reshapeV8Path, "Internal_Deform_Nose",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_NOSE_SWING,mEffectType,true)[0]),true),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_NOSE_MOVE, R.drawable.ic_reshape_nose_move, R.string.beauty_reshape_nose_move,  new ComposerNode(reshapeV8Path, "Internal_Deform_MovNose", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_NOSE_MOVE,mEffectType,true)[0]),true)
        ...
        EffectButtonItem mouthGroup = new EffectButtonItem(TYPE_BEAUTY_RESHAPE_MOUTH,R.drawable.icon_mouth,R.string.beauty_reshape_mouth_group, new EffectButtonItem[]{
                new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border, R.string.close),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_MOUTH_ZOOM, R.drawable.ic_reshape_mouth_zoom, R.string.beauty_reshape_mouth_zoom, new ComposerNode(reshapeV8Path, "Internal_Deform_ZoomMouth", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_MOUTH_ZOOM,mEffectType,true)[0]),true),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_MOUTH_MOVE, R.drawable.ic_reshape_mouth_move, R.string.beauty_reshape_mouth_move,  new ComposerNode(reshapeV8Path, "Internal_Deform_MovMouth", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_MOUTH_MOVE,mEffectType, true)[0]), true),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_MOUTH_SMILE, R.drawable.ic_reshape_mouth_smile, R.string.beauty_reshape_mouth_smile,  new ComposerNode(reshapeV8Path, "Internal_Deform_MouthCorner", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_MOUTH_SMILE,mEffectType)[0])),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_WHITEN_TEETH, R.drawable.ic_reshape_mouth_white_teeth, R.string.beauty_face_whiten_teeth,new ComposerNode("whiten_teeth_Android_lite", "BEF_BEAUTY_WHITEN_TEETH",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_WHITEN_TEETH,mEffectType)[0]))
...
//                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_OVERALL1, R.drawable.ic_beauty_cheek_reshape, R.string.beauty_reshape_face_overall, new ComposerNode(reshapeNode, "Internal_Deform_Overall", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_OVERALL1,mEffectType, true)[0]),true),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_SMALL, R.drawable.ic_beauty_reshape_face_small, R.string.beauty_reshape_face_small, new ComposerNode(NODE_RESHAPE_V8, "Internal_Deform_Face", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_SMALL,mEffectType)[0])),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_SHORT, R.drawable.ic_beauty_reshape_face_small, R.string.beauty_reshape_face_short, new ComposerNode(NODE_RESHAPE_V8, "Internal_Deform_Short_Face", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_SHORT,mEffectType)[0])),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_CUT, R.drawable.ic_beauty_reshape_face_cut, R.string.beauty_reshape_face_cut, new ComposerNode(NODE_RESHAPE_V8, "Internal_Deform_CutFace", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_CUT,mEffectType, true)[0]),true),
                new EffectButtonItem(TYPE_BEAUTY_BODY_SHRINK_HEAD, R.drawable.ic_beauty_body_shrink_head, R.string.beauty_body_shrink_head, new ComposerNode(NODE_RESHAPE_V8, "BEF_BEAUTY_BODY_SHRINK_HEAD",getDefaultIntensity(TYPE_BEAUTY_BODY_SHRINK_HEAD,null)[0])),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_CHEEK, R.drawable.ic_beauty_reshape_cheek, R.string.beauty_reshape_face_cheek, new ComposerNode(NODE_RESHAPE_V8, "Internal_Deform_Zoom_Cheekbone",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_CHEEK,mEffectType, true)[0]),true),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_JAW, R.drawable.ic_beauty_reshape_jaw, R.string.beauty_reshape_face_jaw, new ComposerNode(NODE_RESHAPE_V8, "Internal_Deform_Zoom_Jawbone",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_JAW,mEffectType, true)[0]),true),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_V, R.drawable.ic_beauty_reshape_face_v, R.string.beauty_reshape_face_v, new ComposerNode(NODE_RESHAPE_V8, "Internal_Deform_VFace",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_V,mEffectType)[0])),
                ...
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FOREHEAD, R.drawable.ic_beauty_reshape_forehead, R.string.beauty_reshape_forehead, new ComposerNode(NODE_RESHAPE_V8, "Internal_Deform_Forehead",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FOREHEAD,mEffectType, true)[0]),true),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_SMILE_FOLDS, R.drawable.ic_beauty_reshape_smile_folds, R.string.beauty_face_smile_folds, new ComposerNode("beauty_Android_video", "BEF_BEAUTY_SMILES_FOLDS",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_SMILE_FOLDS,mEffectType)[0]))

        });

        ArrayList<EffectButtonItem>eye_items = new ArrayList<>();
        eye_items.add(new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border, R.string.close));
        eye_items.add(new EffectButtonItem(TYPE_BEAUTY_RESHAPE_EYE_SIZE, R.drawable.ic_reshape_eye_size, R.string.beauty_reshape_eye_size, new ComposerNode(NODE_RESHAPE_V8, "Internal_Deform_Eye", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_EYE_SIZE,mEffectType, true)[0]),true));
        ...
        eye_items.add(new EffectButtonItem(TYPE_BEAUTY_RESHAPE_EYE_LOWER_EYELID, R.drawable.ic_reshape_eye_lower_eyelid, R.string.beauty_reshape_eye_lower_eyelid,new ComposerNode(NODE_RESHAPE_V8, "Internal_LowerEyelid", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_EYE_LOWER_EYELID,mEffectType, true)[0]),true));
        eye_items.add(new EffectButtonItem(TYPE_BEAUTY_RESHAPE_EYE_PUPIL, R.drawable.ic_reshape_eye_pupil, R.string.beauty_reshape_eye_pupil,new ComposerNode(NODE_RESHAPE_V8, "Internal_EyePupil", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_EYE_PUPIL,mEffectType, true)[0]),true));
        ...
        eye_items.add(new EffectButtonItem(TYPE_BEAUTY_RESHAPE_BRIGHTEN_EYE, R.drawable.ic_reshape_eye_brighten, R.string.beauty_face_brighten_eye,new ComposerNode("beauty_Android_lite", "BEF_BEAUTY_BRIGHTEN_EYE",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_BRIGHTEN_EYE,mEffectType)[0])));
        eye_items.add(new EffectButtonItem(TYPE_BEAUTY_RESHAPE_REMOVE_POUCH, R.drawable.ic_reshape_eye_remove_pouch, R.string.beauty_face_remove_pouch,new ComposerNode("beauty_Android_video", "BEF_BEAUTY_REMOVE_POUCH",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_REMOVE_POUCH,mEffectType)[0])));
        ...
        EffectButtonItem noseGroup = new EffectButtonItem(TYPE_BEAUTY_RESHAPE_NOSE,R.drawable.icon_nose,R.string.beauty_reshape_nose_group, new EffectButtonItem[]{
                new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border, R.string.close),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_NOSE_SIZE, R.drawable.ic_reshape_nose_size, R.string.beauty_reshape_nose_deform, new ComposerNode(NODE_RESHAPE_V8, "Internal_Deform_NoseSize", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_NOSE_SIZE,mEffectType, true)[0]),true),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_NOSE_SWING, R.drawable.ic_reshape_nose_swing, R.string.beauty_reshape_nose_swing,new ComposerNode(NODE_RESHAPE_V8, "Internal_Deform_Nose",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_NOSE_SWING,mEffectType, true)[0]),true),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_NOSE_BRIDGE, R.drawable.ic_reshape_nose_bridge, R.string.beauty_reshape_nose_bridge,new ComposerNode(NODE_RESHAPE_V8, "Internal_Deform_NoseBridge",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_NOSE_BRIDGE,mEffectType, true)[0]),true),
                ...
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_NOSE_TIP, R.drawable.ic_reshape_nose_tip, R.string.beauty_reshape_nose_tip,new ComposerNode(NODE_RESHAPE_V8, "Internal_Deform_NoseTip",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_NOSE_TIP,mEffectType, true)[0]),true),
        ...
        EffectButtonItem mouthGroup = new EffectButtonItem(TYPE_BEAUTY_RESHAPE_MOUTH,R.drawable.icon_mouth,R.string.beauty_reshape_mouth_group, new EffectButtonItem[]{
                new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border, R.string.close),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_MOUTH_ZOOM, R.drawable.ic_reshape_mouth_zoom, R.string.beauty_reshape_mouth_zoom, new ComposerNode(NODE_RESHAPE_V8, "Internal_Deform_ZoomMouth", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_MOUTH_ZOOM,mEffectType, true)[0]),true),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_MOUTH_WIDTH, R.drawable.ic_reshape_mouth_width, R.string.beauty_reshape_mouth_width, new ComposerNode(NODE_RESHAPE_V8, "Internal_MouseWidth", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_MOUTH_WIDTH,mEffectType, true)[0]),true),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_MOUTH_MOVE, R.drawable.ic_reshape_mouth_move, R.string.beauty_reshape_mouth_move,  new ComposerNode(NODE_RESHAPE_V8, "Internal_Deform_MovMouth", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_MOUTH_MOVE,mEffectType, true)[0]),true),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_MOUTH_SMILE, R.drawable.ic_reshape_mouth_smile, R.string.beauty_reshape_mouth_smile,  new ComposerNode(NODE_RESHAPE_V8, "Internal_Deform_MouthCorner", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_MOUTH_SMILE,mEffectType)[0])),
                new EffectButtonItem(TYPE_BEAUTY_RESHAPE_WHITEN_TEETH, R.drawable.ic_reshape_mouth_white_teeth, R.string.beauty_face_whiten_teeth,new ComposerNode("whiten_teeth_standard", "BEF_BEAUTY_WHITEN_TEETH",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_WHITEN_TEETH,mEffectType)[0]))
    ...
    private  EffectButtonItem getBeautyBodyItems() {
        if (mEffectType == LITE_ASIA || mEffectType == LITE_NOT_ASIA) {
            return new EffectButtonItem(
                    ...
                    new EffectButtonItem[]{
                            new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border, R.string.close),
                            new EffectButtonItem(TYPE_BEAUTY_BODY_ALL, R.drawable.ic_beauty_body_all, R.string.beauty_body_all, new ComposerNode(NODE_ALL_SLIM, "Beautybody_ALL",getDefaultIntensity(TYPE_BEAUTY_BODY_ALL,null)[0])),
                            ...
                            new EffectButtonItem(TYPE_BEAUTY_BODY_SLIM_LEG, R.drawable.ic_beauty_body_slim_leg, R.string.beauty_body_leg_slim, new ComposerNode("body/allslim_prev", "BEF_BEAUTY_BODY_SLIM_LEG",getDefaultIntensity(TYPE_BEAUTY_BODY_SLIM_LEG,null)[0])),
    ...
    private EffectButtonItem getAmgFilterItems() {
        return new EffectButtonItem(
                TYPE_FILTER_AMG,
                new EffectButtonItem[]{
                        new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border, R.string.close),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_category_portrait, R.string.tab_portrait, getAmgFilterOptionItems(TYPE_FILTER_AMG_PORTRAIT), false),
                        new EffectButtonItem(TYPE_FILTER_AMG_CUISINE, R.drawable.icon_filter_category_cusine, R.string.tab_cuisine, getAmgFilterOptionItems(TYPE_FILTER_AMG_CUISINE), false),
                        new EffectButtonItem(TYPE_FILTER_AMG_LANDSCAPE, R.drawable.icon_filter_category_landscape, R.string.tab_landscape, getAmgFilterOptionItems(TYPE_FILTER_AMG_LANDSCAPE), false),
                        new EffectButtonItem(TYPE_FILTER_AMG_VINTAGE, R.drawable.icon_filter_category_vintage, R.string.tab_vintage, getAmgFilterOptionItems(TYPE_FILTER_AMG_VINTAGE), false),
                        new EffectButtonItem(TYPE_FILTER_AMG_STYLIZATION, R.drawable.icon_filter_category_portrait, R.string.tab_stylization, getAmgFilterOptionItems(TYPE_FILTER_AMG_STYLIZATION), false)
                }
        );
    }
    ...
    private EffectButtonItem[] getAmgFilterOptionItems(int type) {
        switch (type & SUB_MASK) {
            case TYPE_FILTER_AMG_PORTRAIT:
                return new EffectButtonItem[]{
                        new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border, R.string.close),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_roubai, R.string.filter_chalk, new ComposerNode("filters/Filter_01_38", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_ziran, R.string.filter_ziran, new ComposerNode("filters/Filter_38_F1", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_chujian, R.string.filter_chujian, new ComposerNode("filters/Filter_25_Po3", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_qingtou, R.string.filter_qingtou, new ComposerNode("filters/Filter_37_L5", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_wenrou, R.string.filter_wenrou, new ComposerNode("filters/Filter_23_Po1", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_lianaichaotian, R.string.filter_lianaichaotian, new ComposerNode("filters/Filter_24_Po2", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_soft, R.string.filter_soft, new ComposerNode("filters/Filter_28_Po6", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_lengbaipi, R.string.filter_lengbaipi, new ComposerNode("filters/Filter_48_4001", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_touliang, R.string.filter_touliang, new ComposerNode("filters/Filter_49_4002", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_liangju, R.string.filter_liangju, new ComposerNode("filters/Filter_50_4003", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_gaojihui, R.string.filter_gaojihui, new ComposerNode("filters/Filter_32_Po10", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_haibianrenxiang, R.string.filter_haibianrenxiang, new ComposerNode("filters/Filter_31_Po9", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_lengyang, R.string.filter_lengyang, new ComposerNode("filters/Filter_30_Po8", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_hongzong, R.string.filter_hongzong, new ComposerNode("filters/Filter_36_L4", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_naicha, R.string.filter_naicha, new ComposerNode("filters/Filter_27_Po5", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_andiao, R.string.filter_andiao, new ComposerNode("filters/Filter_26_Po4", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_qiannuan, R.string.filter_musi, new ComposerNode("filters/Filter_10_11", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_hutaomu, R.string.filter_hutaomu, new ComposerNode("filters/Filter_51_4004", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_shenhe, R.string.filter_shenhe, new ComposerNode("filters/Filter_52_4005", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_degula, R.string.filter_degula, new ComposerNode("filters/Filter_53_4006", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_naiyou, R.string.filter_cream, new ComposerNode("filters/Filter_02_14", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_makalong, R.string.filter_makalong, new ComposerNode("filters/Filter_07_06", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_yangqi, R.string.filter_oxgen, new ComposerNode("filters/Filter_03_20", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_wuyu, R.string.filter_wuyu, new ComposerNode("filters/Filter_11_09", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_luolita, R.string.filter_lolita, new ComposerNode("filters/Filter_05_10", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_jiegeng, R.string.filter_campan, new ComposerNode("filters/Filter_04_12", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_lise, R.string.filter_lise, new ComposerNode("filters/Filter_54_4007", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_PORTRAIT, R.drawable.icon_filter_yelin, R.string.filter_yelin, new ComposerNode("filters/Filter_55_4008", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                };
            case TYPE_FILTER_AMG_CUISINE:
                return new EffectButtonItem[]{
                        new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border, R.string.close),
                        new EffectButtonItem(TYPE_FILTER_AMG_CUISINE, R.drawable.icon_filter_shise, R.string.filter_shise, new ComposerNode("filters/Filter_41_F4", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_CUISINE, R.drawable.icon_filter_chuanwei, R.string.filter_chuanwei, new ComposerNode("filters/Filter_42_F5", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_CUISINE, R.drawable.icon_filter_suda, R.string.filter_suda, new ComposerNode("filters/Filter_39_F2", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_CUISINE, R.drawable.icon_filter_nuanshi, R.string.filter_nuanshi, new ComposerNode("filters/Filter_56_4009", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_CUISINE, R.drawable.icon_filter_qipaoshui, R.string.filter_qipaoshui, new ComposerNode("filters/Filter_57_4010", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_CUISINE, R.drawable.icon_filter_liaoli, R.string.filter_liaoli, new ComposerNode("filters/Filter_58_4011", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_CUISINE, R.drawable.icon_filter_tanshao, R.string.filter_tanshao, new ComposerNode("filters/Filter_59_4012", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                };
            case TYPE_FILTER_AMG_LANDSCAPE:
                return new EffectButtonItem[]{
                        new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border, R.string.close),
                        new EffectButtonItem(TYPE_FILTER_AMG_LANDSCAPE, R.drawable.icon_filter_yinghua, R.string.filter_yinhua, new ComposerNode("filters/Filter_09_19", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_LANDSCAPE, R.drawable.icon_filter_jiazhou, R.string.filter_jiazhou, new ComposerNode("filters/Filter_40_F3", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_LANDSCAPE, R.drawable.icon_filter_mitao, R.string.filter_mitao, new ComposerNode("filters/Filter_06_03", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_LANDSCAPE, R.drawable.icon_filter_qianxia, R.string.filter_qianxia, new ComposerNode("filters/Filter_34_L2", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_LANDSCAPE, R.drawable.icon_filter_haidao, R.string.filter_haidao, new ComposerNode("filters/Filter_33_L1", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_LANDSCAPE, R.drawable.icon_filter_beihaidao, R.string.filter_beihaidao, new ComposerNode("filters/Filter_12_08", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_LANDSCAPE, R.drawable.icon_filter_xiyang, R.string.filter_xiyang, new ComposerNode("filters/Filter_29_Po7", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_LANDSCAPE, R.drawable.icon_filter_yese, R.string.filter_yese, new ComposerNode("filters/Filter_35_L3", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_LANDSCAPE, R.drawable.icon_filter_jingdu, R.string.filter_jingdu, new ComposerNode("filters/Filter_60_4013", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_LANDSCAPE, R.drawable.icon_filter_haian, R.string.filter_haian, new ComposerNode("filters/Filter_61_4014", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_LANDSCAPE, R.drawable.icon_filter_lyuyan, R.string.filter_lyuyan, new ComposerNode("filters/Filter_62_4015", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_LANDSCAPE, R.drawable.icon_filter_wanying, R.string.filter_wanying, new ComposerNode("filters/Filter_63_4016", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_LANDSCAPE, R.drawable.icon_filter_qingcheng, R.string.filter_qingcheng, new ComposerNode("filters/Filter_64_4017", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_LANDSCAPE, R.drawable.icon_filter_aizhicheng, R.string.filter_aizhicheng, new ComposerNode("filters/Filter_65_4018", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                };
            case TYPE_FILTER_AMG_VINTAGE:
                return new EffectButtonItem[]{
                        new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border, R.string.close),
                        new EffectButtonItem(TYPE_FILTER_AMG_VINTAGE, R.drawable.icon_filter_meishijiaopian, R.string.filter_meishijiaopian, new ComposerNode("filters/Filter_43_S1", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_VINTAGE, R.drawable.icon_filter_hongsefugu, R.string.filter_hongsefugu, new ComposerNode("filters/Filter_44_S2", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_VINTAGE, R.drawable.icon_filter_lyutu, R.string.filter_lvtu, new ComposerNode("filters/Filter_45_S3", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_VINTAGE, R.drawable.icon_filter_nuanhuang, R.string.filter_nuanhuang, new ComposerNode("filters/Filter_46_S4", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_VINTAGE, R.drawable.icon_filter_landiaojiaopian, R.string.filter_landiaojiaopian, new ComposerNode("filters/Filter_47_S5", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_VINTAGE, R.drawable.icon_filter_riza, R.string.filter_riza, new ComposerNode("filters/Filter_13_02", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_VINTAGE, R.drawable.icon_filter_ct, R.string.filter_kangtaishi, new ComposerNode("filters/Filter_66_4019", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_VINTAGE, R.drawable.icon_filter_ek, R.string.filter_aikefa, new ComposerNode("filters/Filter_67_4020", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_VINTAGE, R.drawable.icon_filter_fj, R.string.filter_fushi, new ComposerNode("filters/Filter_68_4021", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                };
            case TYPE_FILTER_AMG_STYLIZATION:
                return new EffectButtonItem[]{
                        new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border, R.string.close),
                        new EffectButtonItem(TYPE_FILTER_AMG_STYLIZATION, R.drawable.icon_filter_hongchun, R.string.filter_hongchun, new ComposerNode("filters/Filter_19_37", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_STYLIZATION, R.drawable.icon_filter_julandiao, R.string.filter_julandiao, new ComposerNode("filters/Filter_20_05", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_STYLIZATION, R.drawable.icon_filter_tuise, R.string.filter_tuise, new ComposerNode("filters/Filter_21_01", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_STYLIZATION, R.drawable.icon_filter_heibai, R.string.filter_heibai, new ComposerNode("filters/Filter_22_16", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_STYLIZATION, R.drawable.icon_filter_heijin, R.string.filter_heijin, new ComposerNode("filters/Filter_69_4022", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                        new EffectButtonItem(TYPE_FILTER_AMG_STYLIZATION, R.drawable.icon_filter_heben, R.string.filter_heben, new ComposerNode("filters/Filter_70_4023", "Filter_ALL", getDefaultIntensity(TYPE_FILTER_AMG,null)[0])),
                };
            default:
                return null;
        }
    ...
    private  EffectButtonItem[] getMakeupOptionItems(int type) {
        String reshapeV8Path = mEffectType == LITE_ASIA || mEffectType == LITE_NOT_ASIA ? "reshape_v8_lite" : "reshape_v8";
        switch (type & SUB_MASK) {
            ...
            case TYPE_MAKEUP_FACIAL:
                if (mEffectType == LITE_ASIA || mEffectType == LITE_NOT_ASIA){
                    return new EffectButtonItem[]{
                            ...
                            new EffectButtonItem(TYPE_MAKEUP_FACIAL, R.drawable.ic_makeup_facial,  R.string.facial_shensui,  new ComposerNode( "facial/shensui",  "Internal_Makeup_Facial",getDefaultIntensity(TYPE_MAKEUP_FACIAL,null)[0])),
                    };
                }else {
                    return new EffectButtonItem[]{
                            new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border,  R.string.close),
                            ...
                            new EffectButtonItem(TYPE_MAKEUP_FACIAL, R.drawable.ic_makeup_facial,  R.string.facial_yingjun,  new ComposerNode( "facial/yingjun",  "Internal_Makeup_Facial",getDefaultIntensity(TYPE_MAKEUP_FACIAL,null)[0]))
                    };
            ...
            case TYPE_MAKEUP_EYELASH:
                ...
                return new EffectButtonItem[]{
                        new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border,  R.string.close),
                        new EffectButtonItem(TYPE_MAKEUP_EYELASH, R.drawable.ic_makeup_eyelash,  R.string.eyelash_ziran,  new ComposerNode( "eyelashes/ziran",  "Internal_Makeup_Eyelash", getDefaultIntensity(TYPE_MAKEUP_EYELASH,STANDARD_ASIA)[0])),
                        new EffectButtonItem(TYPE_MAKEUP_EYELASH, R.drawable.ic_makeup_eyelash,  R.string.eyelash_juanqiao,  new ComposerNode( "eyelashes/juanqiao",  "Internal_Makeup_Eyelash", getDefaultIntensity(TYPE_MAKEUP_EYELASH,STANDARD_ASIA)[0])),
                        new EffectButtonItem(TYPE_MAKEUP_EYELASH, R.drawable.ic_makeup_eyelash,  R.string.eyelash_chibang,  new ComposerNode( "eyelashes/chibang",  "Internal_Makeup_Eyelash", getDefaultIntensity(TYPE_MAKEUP_EYELASH,STANDARD_ASIA)[0])),
                        new EffectButtonItem(TYPE_MAKEUP_EYELASH, R.drawable.ic_makeup_eyelash,  R.string.eyelash_manhua,  new ComposerNode( "eyelashes/manhua",  "Internal_Makeup_Eyelash", getDefaultIntensity(TYPE_MAKEUP_EYELASH,STANDARD_ASIA)[0])),
                        new EffectButtonItem(TYPE_MAKEUP_EYELASH, R.drawable.ic_makeup_eyelash,  R.string.eyelash_xiachui,  new ComposerNode( "eyelashes/xiachui",  "Internal_Makeup_Eyelash", getDefaultIntensity(TYPE_MAKEUP_EYELASH,STANDARD_ASIA)[0])),
                };
            ...
            case TYPE_BEAUTY_RESHAPE_FACE_OVERALL:
                if (mEffectType == STANDARD_ASIA || mEffectType == STANDARD_NOT_ASIA) {
                    return new EffectButtonItem[]{
                            new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border,  R.string.close),
                            new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_OVERALL4, R.drawable.ic_beauty_cheek_reshape_ziranlian, R.string.beauty_reshape_face_ziranlian, new ComposerNode(reshapeV8Path, "Face_ALL_nature", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_OVERALL4,mEffectType)[0])),
                            new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_OVERALL2, R.drawable.ic_beauty_cheek_reshape_nvshen, R.string.beauty_reshape_face_nvshen, new ComposerNode(reshapeV8Path, "Face_ALL_girl", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_OVERALL2,mEffectType)[0])),
                            new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_OVERALL3, R.drawable.ic_beauty_cheek_reshape_nanshen, R.string.beauty_reshape_face_nanshen, new ComposerNode(reshapeV8Path, "Face_ALL_boy", getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_OVERALL3,mEffectType)[0])),
                    };
                }
                else {
                    return new EffectButtonItem[]{
                            new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border,  R.string.close),
                            new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_OVERALL4, R.drawable.ic_beauty_cheek_reshape_ziranlian,  R.string.beauty_reshape_face_ziranlian,  new ComposerNode( reshapeV8Path,  "Face_ALL_nature",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_OVERALL4,mEffectType)[0])),
                            new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_OVERALL3, R.drawable.ic_beauty_cheek_reshape_nvshen,  R.string.beauty_reshape_face_nvshen,  new ComposerNode( reshapeV8Path,  "Face_ALL_girl",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_OVERALL3,mEffectType)[0])),
                            new EffectButtonItem(TYPE_BEAUTY_RESHAPE_FACE_OVERALL2, R.drawable.ic_beauty_cheek_reshape_nanshen,  R.string.beauty_reshape_face_nanshen,  new ComposerNode( reshapeV8Path,  "Face_ALL_boy",getDefaultIntensity(TYPE_BEAUTY_RESHAPE_FACE_OVERALL2,mEffectType)[0])),
                    };
                }
            case TYPE_BEAUTY_FACE_WHITEN:
                if (mEffectType == EffectType.STANDARD_ASIA || mEffectType == EffectType.STANDARD_NOT_ASIA) {
                    return new EffectButtonItem[]{
                            new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border,  R.string.close),
                            new EffectButtonItem(TYPE_BEAUTY_FACE_WHITEN_DEFAULT, R.drawable.ic_beauty_whiten_default, R.string.eyelash_ziran, new ComposerNode("beauty_ziran_standard", new String[]{"whiten", "warm"}, getDefaultIntensity(TYPE_BEAUTY_FACE_WHITEN_DEFAULT,mEffectType))),
                            new EffectButtonItem(TYPE_BEAUTY_FACE_WHITEN_LENGBAI, R.drawable.ic_beauty_whiten_cool, R.string.style_makeup_baixi, new ComposerNode("beauty_lengbai_standard",  new String[]{"whiten", "warm"},getDefaultIntensity(TYPE_BEAUTY_FACE_WHITEN_LENGBAI,mEffectType))),
                            new EffectButtonItem(TYPE_BEAUTY_FACE_WHITEN_FENBAI, R.drawable.ic_beauty_whiten_pink, R.string.beauty_face_whiten_fenbai, new ComposerNode("beauty_fenbai_standard",  new String[]{"whiten", "warm"},getDefaultIntensity(TYPE_BEAUTY_FACE_WHITEN_FENBAI,mEffectType))),
                            new EffectButtonItem(TYPE_BEAUTY_FACE_WHITEN_XIAOMAI, R.drawable.ic_beauty_whiten_xiaomaise, R.string.beauty_face_whiten_xiaomaise, new ComposerNode("beauty_xiaomai_standard",  new String[]{"whiten", "warm"},getDefaultIntensity(TYPE_BEAUTY_FACE_WHITEN_XIAOMAI,mEffectType))),
                            new EffectButtonItem(TYPE_BEAUTY_FACE_WHITEN_MEIHEI, R.drawable.ic_beauty_whiten_meihei, R.string.beauty_face_whiten_meihe, new ComposerNode("beauty_meihei_standard",  new String[]{"whiten", "warm"},getDefaultIntensity(TYPE_BEAUTY_FACE_WHITEN_MEIHEI,mEffectType))),
                    };
                } else {
                    return new EffectButtonItem[]{
                            new EffectButtonItem(TYPE_CLOSE, R.drawable.clear_no_border,  R.string.close),
                            new EffectButtonItem(TYPE_BEAUTY_FACE_WHITEN_DEFAULT, R.drawable.ic_beauty_whiten_default, R.string.eyelash_ziran, new ComposerNode("whiten_clear_Android_lite", "whiten", getDefaultIntensity(TYPE_BEAUTY_FACE_WHITEN_DEFAULT,mEffectType)[0])),
                            new EffectButtonItem(TYPE_BEAUTY_FACE_WHITEN_LENGBAI, R.drawable.ic_beauty_whiten_cool, R.string.style_makeup_baixi, new ComposerNode("beauty_Android_lengbai_lite",  "whiten",getDefaultIntensity(TYPE_BEAUTY_FACE_WHITEN_LENGBAI,mEffectType)[0])),
                            new EffectButtonItem(TYPE_BEAUTY_FACE_WHITEN_FENBAI, R.drawable.ic_beauty_whiten_pink, R.string.beauty_face_whiten_fenbai, new ComposerNode("beauty_Android_fenbai_lite",  "whiten",getDefaultIntensity(TYPE_BEAUTY_FACE_WHITEN_FENBAI,mEffectType)[0])),
                            new EffectButtonItem(TYPE_BEAUTY_FACE_WHITEN_HONGRUN, R.drawable.ic_beauty_whiten_rosy, R.string.beauty_face_whiten_hongrun, new ComposerNode("beauty_Android_rosy_lite",  "whiten",getDefaultIntensity(TYPE_BEAUTY_FACE_WHITEN_HONGRUN,mEffectType)[0])),
                    };
                }
        }
        return null;
...
//    }
    ...
    private  EffectButtonItem getStyleMakeup2DItems() {
        return new EffectButtonItem(
                ...
                new EffectButtonItem[]{
                        ...
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_babi, R.string.style_makeup_babi, new ComposerNode("style_makeup/babi", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "babi"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_danyan, R.string.style_makeup_danyan, new ComposerNode("style_makeup/danyan", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "danyan"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_qingtou, R.string.style_makeup_qingtou, new ComposerNode("style_makeup/qingtou", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "qingtou"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_shaonian, R.string.style_makeup_shaonian, new ComposerNode("style_makeup/shaonian", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "shaonian"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_weisuyan, R.string.style_makeup_weisuyan, new ComposerNode("style_makeup/weisuyan", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "weisuyan"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_xuejie, R.string.style_makeup_xuejie, new ComposerNode("style_makeup/xuejie", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "xuejie"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_xuemei, R.string.style_makeup_xuemei, new ComposerNode("style_makeup/xuemei", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "xuemei"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_yangguang, R.string.style_makeup_yangguang, new ComposerNode("style_makeup/yangguang", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "yangguang"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_yinglang, R.string.style_makeup_yinglang, new ComposerNode("style_makeup/yinglang", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "yinglang"),
                },
                false
        );
    }
    ...
    private  EffectButtonItem getLocalStyleMakeup2DItems() {
        return new EffectButtonItem(
                ...
                new EffectButtonItem[]{
                        new EffectButtonItem(TYPE_CLOSE, R.drawable.clear, R.string.close),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_weisuyan, R.string.style_makeup_weisuyan, new ComposerNode("style_makeup_local/weisuyan", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "weisuyan"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_xuejie, R.string.style_makeup_xuejie, new ComposerNode("style_makeup_local/xuejie", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "xuejie"),
                        ...
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_xuemei, R.string.style_makeup_xuemei, new ComposerNode("style_makeup_local/xuemei", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "xuemei"),
                        ...
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_baixi, R.string.style_makeup_baixi, new ComposerNode("style_makeup_local/baixi", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "baixi"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_shensui, R.string.style_makeup_shensui, new ComposerNode("style_makeup_local/shensui", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "shensui"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_qingtou, R.string.style_makeup_qingtou, new ComposerNode("style_makeup_local/qingtou", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "qingtou"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_qizhi, R.string.style_makeup_qizhi, new ComposerNode("style_makeup_local/qizhi", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "qizhi"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_babi, R.string.style_makeup_babi, new ComposerNode("style_makeup_local/babi", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "babi"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_yangguang, R.string.style_makeup_yangguang, new ComposerNode("style_makeup_local/yangguang", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "yangguang"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_hanxi, R.string.style_makeup_hanxi, new ComposerNode("style_makeup_local/hanxi", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "hanxi"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_cwei, R.string.style_makeup_cwei, new ComposerNode("style_makeup_local/Cwei", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "Cwei"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_tianmei, R.string.style_makeup_tianmei, new ComposerNode("style_makeup_local/tianmei", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "tianmei"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_zhigan, R.string.style_makeup_zhigan, new ComposerNode("style_makeup_local/zhigan", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "zhigan"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_nuannan, R.string.style_makeup_nuannan, new ComposerNode("style_makeup_local/nuannan", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "nuannan"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_yuanqi, R.string.style_makeup_yuanqi, new ComposerNode("style_makeup_local/yuanqi", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "yuanqi"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_aidou, R.string.style_makeup_aidou, new ComposerNode("style_makeup_local/aidou", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "aidou"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_duanmei, R.string.style_makeup_duanmei, new ComposerNode("style_makeup_local/duanmei", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "duanmei"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_wennuan, R.string.style_makeup_wennuan, new ComposerNode("style_makeup_local/wennuan", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "wennuan"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_oumei, R.string.style_makeup_oumei, new ComposerNode("style_makeup_local/oumei", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "oumei"),
                        new EffectButtonItem(TYPE_STYLE_MAKEUP_2D, R.drawable.icon_youya, R.string.style_makeup_youya, new ComposerNode("style_makeup_local/youya", new String[]{"Filter_ALL", "Makeup_ALL"}, getDefaultIntensity(TYPE_STYLE_MAKEUP, LITE_ASIA)), "youya"),
                },
                false
        );
    }
