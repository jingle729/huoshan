...
public class FilterCategoryRVAdapter extends ItemViewRVAdapter<FilterItem, ButtonViewHolder>{
    ...
    public FilterCategoryRVAdapter(List<FilterItem> itemList, OnItemClickListener<FilterItem> listener) {
    ...
    @Override
    public void onBindViewHolderInternal(ButtonViewHolder holder, int position, FilterItem item) {
    ...
    public FilterCategoryRVAdapter usePoint(boolean showPoint) {
