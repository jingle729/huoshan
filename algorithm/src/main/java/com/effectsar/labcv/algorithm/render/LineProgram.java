...
public class LineProgram extends ShaderProgram {
    ...
    public void drawRect(RectF rect, int color, float lineWidth) {
        ...
        //   {zh} 将 stickerType 设置为 GL_LINE_LOOP 时只是需要指定四个顶点，系统会自动构成回路       {en} When the stickerType is set to GL_LINE_LOOP, only four vertices need to be specified, and the system will automatically form a loop  
