package com.effectsar.labcv.algorithm.view;
...
public class PetFaceInfoTip extends ResultTip<BefPetFaceInfo.PetFace> {
    ...
    public PetFaceInfoTip(@NonNull Context context) {
        ...
        if (mActionMap == null) {
            ...
            mActionMap.put(EffectsSDKEffectConstants.PetFaceAction.BEF_LEFT_EYE_PET_FACE, tvLeftEye);
            mActionMap.put(EffectsSDKEffectConstants.PetFaceAction.BEF_RIGHT_EYE_PET_FACE, tvRightEye);
            mActionMap.put(EffectsSDKEffectConstants.PetFaceAction.BEF_MOUTH_PET_FACE, tvMouth);
