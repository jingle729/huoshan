...
) : RecyclerView.Adapter<CategoryListAdapter.ItemListViewHolder>() {

    var clickAction: ((Int, Category) -> Unit)? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemListViewHolder {
        return ItemListViewHolder(parent.inflate(R.layout.layout_category_item))
    }
