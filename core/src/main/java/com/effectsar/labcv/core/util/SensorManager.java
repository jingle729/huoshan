...
public class SensorManager  {
    ...
    private SensorEventListener mGryoscopListener = new SensorEventListener() {
        @Override
    ...
    private  SensorEventListener mGravityListenser = new SensorEventListener() {
        @Override
        public void onSensorChanged(SensorEvent sensorEvent) {
            double time = sensorEvent.timestamp;
            if (mListener != null)  {
    ...
    private SensorEventListener mAcceleratorListener = new SensorEventListener() {
        @Override
        public void onSensorChanged(SensorEvent sensorEvent) {
            double time = sensorEvent.timestamp;
            if (mListener != null)  {
    ...
    private  SensorEventListener mRotationVectorListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent sensorEvent) {
            ...
            mManager.getRotationMatrixFromVector(rb, sensorEvent.values);
