...
public class Config {
    public static final String LICENSE_NAME = BuildConfig.LICENSE_NAME;
    ...
    public static final String PANEL_KEY = "v471";
    ...
    public static final boolean ENABLE_ASSETS_SYNC = false;
