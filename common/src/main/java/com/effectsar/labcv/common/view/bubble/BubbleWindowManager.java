...
public class BubbleWindowManager {
    ...
    public enum ITEM_TYPE{
        EFFECT_TYPE,PERFORMANCE,BEAUTY,RESOLUTION,PICTURE_MODE,VIDEO_SCALE;
    }
    ...
    public  interface BubbleCallback{
        ...
        void onVideoScaleChanged(int width, int height);
    ...
    public BubbleWindowManager(Context context) {
        ...
        mPopupWindow.setParam(DensityUtils.getScreenWidth((Activity) mContext) - mContext.getResources().getDimensionPixelSize(com.effectsar.labcv.common.R.dimen.popwindow_margin) * 2, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        mConfig.setVideoScale(new Point(16,9));
    }
...
//                            mConfig.setResolution(resolution == 720?new Point(1280,720):new Point(640,480));
                ...
                case PICTURE_MODE:
                    ...
                    break;
                    case VIDEO_SCALE:
                        mBubbleView.findViewById(R.id.rl_video_scale).setVisibility(View.VISIBLE);
                        RadioGroup rg_videoScale =  mBubbleView.findViewById(R.id.rg_video_scale);
                        switch(mConfig.getVideoScale().x){
                            case 9:
                                rg_videoScale.check(R.id.rb_9_16);
                                break;
                            case 4:
                                rg_videoScale.check(R.id.rb_4_3);
                                break;
                            default:
                                rg_videoScale.check(R.id.rb_16_9);
                                break;
                        }
                        rg_videoScale.setOnCheckedChangeListener((radioGroup, i) -> {
                            if (mBubbleCallback != null) {
                                if (i == R.id.rb_16_9){
                                    ((RadioButton)mBubbleView.findViewById(R.id.rb_720)).setText("1280*720");
                                    ((RadioButton)mBubbleView.findViewById(R.id.rb_1080)).setText("1920*1080");
                                    mBubbleCallback.onVideoScaleChanged(16,9);
                                    mConfig.setVideoScale(new Point(16,9));
                                }else if (i == R.id.rb_4_3){
                                    ((RadioButton)mBubbleView.findViewById(R.id.rb_720)).setText("960*720");
                                    ((RadioButton)mBubbleView.findViewById(R.id.rb_1080)).setText("1440*1080");
                                    mBubbleCallback.onVideoScaleChanged(4,3);
                                    mConfig.setVideoScale(new Point(4,3));
                                }else if (i == R.id.rb_9_16){
                                    ((RadioButton)mBubbleView.findViewById(R.id.rb_720)).setText("720*1280");
                                    ((RadioButton)mBubbleView.findViewById(R.id.rb_1080)).setText("1080*1920");
                                    mBubbleCallback.onVideoScaleChanged(9,16);
                                    mConfig.setVideoScale(new Point(9,16));
                                }
                            }
                        });
                        break;
        ...
        int offset = anchor.getLeft()+anchor.getWidth()/2 - mContext.getResources().getDimensionPixelSize(com.effectsar.labcv.common.R.dimen.popwindow_margin);
